...
class MCPGatewayConnect(BaseTool):
    ...
    async def _execute(self, arguments: Dict[str, Any]) -> Dict[str, Any]:
        ...
        logger.info("Connecting to MCP server", server_name=server_name, transport=transport_type)
...
class MCPGatewayDisconnect(BaseTool):
    ...
    async def _execute(self, arguments: Dict[str, Any]) -> Dict[str, Any]:
        ...
        logger.info("Successfully disconnected from MCP server", server_name=server_name)
...
class MCPGatewayListResources(BaseTool):
    ...
    async def _execute(self, arguments: Dict[str, Any]) -> Dict[str, Any]:
        ...
        logger.info("Listed resources from MCP servers", total_resources=total_resources)
        
        return {
            "servers": all_resources,
